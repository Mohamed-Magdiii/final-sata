...
const CityForm = ({ getCities,addShipping ,getCountries, country:{countries , cities}}) => {
    useEffect(()=>{
        getCities()
        getCountries()
    },[])
...
export default connect(mapStateToProps, {addShipping, getCountries , getCities})(CityForm)
